...
public class CategoryBracelet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_bracelet);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Bracelet");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        DesignRef = FirebaseDatabase.getInstance().getReference().child("designs");

        recyclerView = findViewById(R.id.recycleView_bracelet);
        ...
        FirebaseRecyclerAdapter<Designs, DesignViewHolder> adapter =
                new FirebaseRecyclerAdapter<Designs, DesignViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull DesignViewHolder holder, int position, @NonNull final Designs model) {
                        if (model.getCategory().equalsIgnoreCase("Bracelet")) {
                            ...
                            holder.cardView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    Intent intent = new Intent(CategoryBracelet.this, DesignDescription.class);
