...
public class CategoryLocket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_locket);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Locket");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        DesignRef = FirebaseDatabase.getInstance().getReference().child("designs");

        recyclerView = findViewById(R.id.recycleView_locket);
        ...
        FirebaseRecyclerAdapter<Designs, DesignViewHolder> adapter =
                new FirebaseRecyclerAdapter<Designs, DesignViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull DesignViewHolder holder, int position, @NonNull final Designs model) {
                        if (model.getCategory().equalsIgnoreCase("Locket")) {
                            ...
                            holder.cardView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    Intent intent = new Intent(CategoryLocket.this, DesignDescription.class);
